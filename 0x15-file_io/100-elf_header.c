 ...
 * @e_type: The ELF type.
 * @e_ident: pointerthat points to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @e_ident: pointer that points to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * Return: success(0)
 * Description: when or if the  file is not an ELF File or
