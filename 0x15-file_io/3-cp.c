...
/**
 * check97 - checks the correct number of arguments
...
/**
 * check99 - check if file_to was created and can be written to
 * @check: checks if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
...
/**
 * check100 - check if the file descriptors are closed properly
